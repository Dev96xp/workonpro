...
class WriteWelcomePage extends Command
{
    protected $signature = 'app:write-welcome-page';

    protected $description = 'Writes the new welcome page design';
...
BLADE;
        ...
        file_put_contents(resource_path('views/welcome.blade.php'), $content);
        $this->info('Welcome page written: '.strlen($content).' bytes');
    }
}
